...
// My Functions
// Finds the highest intensity value of a geofence
function maxIntensity(features) {
	var maxValue = 0;

	for (var i = 0; i < features.length; i++) {
		if (features[i].properties.intensity > maxValue)
				maxValue = features[i].properties.intensity;
	}
	return maxValue;
}

// K-Means 
//function kMeans(k, features) {
